...
> 📸 **Placeholder**: POST request showing `Content-Type: text/event-stream` with incremental data frames
...
> 📸 **Placeholder**: Single POST request with streamed response completing and closing cleanly
